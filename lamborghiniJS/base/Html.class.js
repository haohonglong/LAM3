const Html = function(System){
	'use strict';
	System.is(System,'Component','Html',System.classPath+'/base');
    ...
    function ajax_success_callback(data,textStatus,jqXHR){
        var _this = this;
        data = System.Template.include(System.Template.define(data));
	...
	var __this__=null;
	var Html = System.Component.extend({
        /**
         *
         * @author: lhh
         * 产品介绍：
...
module.exports = {'class':Html,'name':'Html'};